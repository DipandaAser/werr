...
<div class="takeover">
  <span class="titleContainer">
    <div class="mobileDropdownHeader">
      <div class="container">
        <img alt="avatar" src={logoMobileWhite} class="avatar" />
      </div>
    </div>
    <button class="closeButton" on:click={closeFunction}>
      <Icon icon="basil:cross-outline" color="white" width="24" height="24" />
    </button>
  </span>
  <hr class="divider" />
  <div class="contentContainer">
    ...
    <div>
      <GlobalMenu onLangChange={closeFunction} />
    </div>
  </div>
</div>
